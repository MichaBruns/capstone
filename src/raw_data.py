    ...
    def load_gt(self, labelPath):
        ...
        with open(labelPath, 'r') as f:
            for line in f:
                ...
                # use the same interface as raw_data
                translation = [float(fields[11]), float(fields[12]), float(fields[13])]
                rotation = [0, 0, float(fields[14])]
                size = [float(fields[8]), float(fields[9]), float(fields[10])]
                boxes3d.append(
                    net.processing.boxes3d.box3d_compose(translation=translation, rotation=rotation, size=size))

                labels.append(fields[0])

        return labels, boxes3d
...
if __name__ == '__main__':
    ...
    for one_frame_tag in tags:
        ...
        # save class, truncation, occlusion, alpha, x1, y2, x2, y2, h, w, l, t1, t2, t3, ry
