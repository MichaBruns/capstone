...
__C.SINGLE_CLASS_DETECTION = False
...
if __C.DATA_SETS_TYPE=='test':
    ...
    __C.DATA_SETS_DIR2=osp.join( '/media/micha/VideoHDD/Udacity/', 'data')
    __C.DATA_SETS_DIR=osp.join('/media/micha/VideoHDD/Udacity/', 'data')

__C.RAW_DATA_SETS_DIR = osp.join(__C.DATA_SETS_DIR2, 'raw', __C.DATA_SETS_TYPE)
...
if __C.DATA_SETS_TYPE == 'didi' or __C.DATA_SETS_TYPE == 'test':
    ...
    if __C.OBJ_TYPE =='car':
        ...
        TOP_X_DIVISION = 0.1
        TOP_Y_DIVISION = 0.1
        TOP_Z_DIVISION = (TOP_Z_MAX - TOP_Z_MIN) / 15#0.1
    elif __C.OBJ_TYPE =='ped':
        TOP_Y_MIN = -20
        TOP_Y_MAX = +20
        TOP_X_MIN = 0
        TOP_X_MAX = 48
...
TOP_X_SIZE = (TOP_X_MAX - TOP_X_MIN) / TOP_X_DIVISION
TOP_Y_SIZE = (TOP_Y_MAX - TOP_Y_MIN) / TOP_Y_DIVISION
TOP_Z_SIZE = (TOP_Y_MAX - TOP_Y_MIN) / TOP_Y_DIVISION
